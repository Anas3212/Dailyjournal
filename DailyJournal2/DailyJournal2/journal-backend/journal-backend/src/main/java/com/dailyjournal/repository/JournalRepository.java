...
public interface JournalRepository extends JpaRepository<JournalEntry, Long> {
        ...
        // Media access: find journal by exact media path (local filename or full
        // Cloudinary URL)
        ...
        // Media access: fallback — find by filename suffix (handles path-prefixed
        // filenames)
        ...
        List<JournalEntry> findByUser_NameContainingIgnoreCaseOrUser_EmailContainingIgnoreCase(String name,
                        String email);
        ...
        // Admin methods to fetch all journals that were ever published (including
        // hidden ones)
