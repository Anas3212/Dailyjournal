...
public interface UserSessionRepository extends JpaRepository<UserSession, Long> {
    ...
    List<UserSession> findSessionsExpiringSoon(@Param("now") LocalDateTime now,
    ...
    int revokeAllUserSessionsExcept(@Param("userId") Long userId, @Param("currentSessionId") String currentSessionId,
    ...
    int updateSessionJwtHash(@Param("sessionId") String sessionId, @Param("newJwtHash") String newJwtHash,
    ...
    int updateSessionExpiration(@Param("sessionId") String sessionId, @Param("newExpiry") LocalDateTime newExpiry,
            @Param("now") LocalDateTime now);

    /**
     * Find sessions that will expire within a specific time window (for
     * notifications)
     */
    ...
    List<UserSession> findSessionsExpiringWithinWindow(@Param("now") LocalDateTime now,
            @Param("threshold") LocalDateTime threshold);
